...
Isolated probability questions only: given a starting pity/guarantee state
and mechanics data, how likely is one featured copy within N wishes?
...
10. The Phase 4 Monte Carlo simulator must reproduce these results for
    equivalent single-copy scenarios within sampling error.
"""
